...
class ETHClass {
    ...
    public:
        ...
        bool dhcpsConfig(IPAddress localStartIp, IPAddress gateway, IPAddress subnet);
        ...
        bool disableDHCPServer();
        bool enableDHCPServer(IPAddress localStartIp, IPAddress gateway, IPAddress subnet);
